<html>
<body>
<h2>DevSecOps by Bishwajeet - 8319310740</h2>
<p>Jenkins is a powerful application that allows Continuous
Integration and Continuous Delivery/Deployment of projects, regardless of the
...
<p>Docker has revolutionized containerization of applications allowing Devops to package any
...
considered as most popular DevOps tool.
Docker Engine, a portable, lightweight run-time and
packaging tool for building containerized apps.
Docker Hub, a cloud service for sharing apps and
